...
# Test with the ACTUAL end-of-call format that Vapi sends
# Based on Vapi's end-of-call webhook documentation

echo "Testing with actual Vapi end-of-call format (from Vapi docs)..."
echo ""
...
curl -X POST http://localhost:3000/webhooks/reservation-complete \
  ...
  -d '{
    "message": {
      ...
      "durationMinutes": 2.1266
    }
  }'

echo ""
echo ""
echo "If you see a success response with phone number +34655720245, it works!"
